...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('is_favorited', models.BooleanField(default=True, help_text='Добавьте рецепт в избранное', verbose_name='Находится в избранном')),
                ('is_in_shopping_cart', models.BooleanField(default=True, help_text='Добавьте рецепт в корзину', verbose_name='Находится в корзине')),
                ('image', models.ImageField(help_text='Добавьте изображение рецепта', upload_to='recipes_images', verbose_name='Изображение рецепта')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount', models.PositiveSmallIntegerField(help_text='Укажите кол-во ингредиента не менее 1', validators=[django.core.validators.MinValueValidator(1, 'Минимальное кол-во ингредиента'), django.core.validators.MaxValueValidator(32000, 'Максимальное кол-во ингредиента')], verbose_name='Кол-во ингредиента')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(help_text='Укажите цвет в формате HEX', max_length=7, null=True, unique=True, validators=[django.core.validators.RegexValidator('^#[0-9A-F]{6}$')], verbose_name='Цвет')),
